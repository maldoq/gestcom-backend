...
from .views import UserViewSet, BoutiqueViewSet, ProduitViewSet, FournisseurViewSet, FactureViewSet, FactureItemViewSet, PaiementViewSet, ReapprovisionnementViewSet, CategorieViewSet
